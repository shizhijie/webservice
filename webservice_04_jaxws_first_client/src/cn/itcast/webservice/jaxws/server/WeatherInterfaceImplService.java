 ...
 * 
 */
@WebServiceClient(name = "WeatherInterfaceImplService", targetNamespace = "http://server.jaxws.webservice.itcast.cn/", wsdlLocation = "http://198.216.5.142:12345/weather?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEATHERINTERFACEIMPLSERVICE_QNAME = new QName("http://server.jaxws.webservice.itcast.cn/", "WeatherInterfaceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://198.216.5.142:12345/weather?wsdl");
    ...
    public WeatherInterfaceImpl getWeatherInterfaceImplPort() {
        return super.getPort(new QName("http://server.jaxws.webservice.itcast.cn/", "WeatherInterfaceImplPort"), WeatherInterfaceImpl.class);
    }
    ...
    public WeatherInterfaceImpl getWeatherInterfaceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.jaxws.webservice.itcast.cn/", "WeatherInterfaceImplPort"), WeatherInterfaceImpl.class, features);
    }
