 ...
 * generated in the cn.itcast.webservice.jaxws.server package. 
...
public class ObjectFactory {
    ...
    private final static QName _QueryWeather_QNAME = new QName("http://server.jaxws.webservice.itcast.cn/", "queryWeather");
    private final static QName _QueryWeatherResponse_QNAME = new QName("http://server.jaxws.webservice.itcast.cn/", "queryWeatherResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: cn.itcast.webservice.jaxws.server
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.jaxws.webservice.itcast.cn/", name = "queryWeather")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.jaxws.webservice.itcast.cn/", name = "queryWeatherResponse")
