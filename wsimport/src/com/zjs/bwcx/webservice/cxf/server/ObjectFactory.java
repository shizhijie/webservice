 ...
 * generated in the cn.itcast.webservice.cxf.server package. 
...
public class ObjectFactory {
    ...
    private final static QName _QueryWeatherResponse_QNAME = new QName("http://server.cxf.webservice.itcast.cn/", "queryWeatherResponse");
    private final static QName _QueryWeather_QNAME = new QName("http://server.cxf.webservice.itcast.cn/", "queryWeather");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: cn.itcast.webservice.cxf.server
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.cxf.webservice.itcast.cn/", name = "queryWeatherResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.cxf.webservice.itcast.cn/", name = "queryWeather")
